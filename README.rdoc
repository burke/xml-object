...
methods are preserved (this is on purpose). To access the attribute +id+, use
outer[:attr => 'object_id'], or outer['object_id'] since there's no
element/attribute ambiguity.
